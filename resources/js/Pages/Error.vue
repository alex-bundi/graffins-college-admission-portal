...
<template>
    <Head title="Error" />
<div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 p-12">
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p class="text-5xl md:text-8xl lg:text-9xl font-bold tracking-wider text-primaryColor font-monteserat ">{{ statusCode }}</p>
        <p class="text-5xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">Server Error</p>
        <p class="text-lg font-josefin tracking-wider font-bold md:text-xl lg:text-2xl text-gray-500 my-12">
            {{ data }}
        </p>

        <div class="flex flex-col space-y-8 sm:space-y-0 sm:flex-row sm:space-x-12 items-center">

            <Link href="/" class="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-primaryColor font-medium">
                <div class="inline-flex h-12 translate-y-0 items-center justify-center bg-white px-6 text-neutral-950 transition group-hover:-translate-y-[150%]">
                    Go Back Home</div>
                    <div class="absolute inline-flex h-12 w-full translate-y-[100%] items-center justify-center bg-darkPrimaryColor px-6 text-neutral-50 
