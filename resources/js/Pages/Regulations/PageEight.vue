...
<template>
    ...
    <AuthenticatedLayout>
                ...
                <li>
                    <p class="font-josefin font-bold text-base tracking-wider">
                        ...
                        <span class="font-monteserat font-extrabold">image, voice, or likeness   </span> 
                         educational media without compensation.
        ...
        <div>
             <div class="w-1/4">
                <Link :href="route('declaration')" class="flex items-center gap-2 px-6 py-3 text-white text-xl font-josefin tracking-wider font-bold 
