    ...
    <AuthenticatedLayout>
        ...
        <div class="mt-4">
            <h2 class="font-monteserat text-base tracking-wider md:text-2xl">
                📘 Graffins College – Rules & Regulations 
        ...
        <div class="mt-4">
            <ul>
                ...
                <li>
                    <p class="font-josefin font-bold text-base tracking-wider">
                        <span class="font-monteserat font-extrabold">Absenteeism</span> 
                        without proper documentation may lead to discontinuation.
        ...
        <div>
             <div class="w-1/4">
                <Link :href="route('page.two')" class="flex items-center gap-2 px-6 py-3 text-white text-xl font-josefin tracking-wider font-bold 
