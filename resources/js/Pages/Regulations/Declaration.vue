...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                ...
                <p class="font-josefin font-bold text-base sm:text-xl tracking-wider">
                    I have read, understood, and agree to abide by the Rules & Regulations of Graffins College.
                </p>
            </div>
        </div>
        ...
        <div>
             <div class="w-1/4">
                <Link :href="route('bio.data.summary')" class="flex items-center gap-2 px-6 py-3 text-white text-xl font-josefin tracking-wider font-bold 
