...
<template>
    ...
    <AuthenticatedLayout>
            ...
            <ul>
                ...
                <li>
                    <p class="font-josefin font-bold text-base tracking-wider">
                        <span class="font-monteserat font-extrabold">Letters:</span> 

                    </p>
                    <ul class="flex flex-col space-y-4 p-4 font-josefin text-sm tracking-wider">
                        <li>
                            - First Attachment/Recommendation Letter is free.
                        </li>
                        <li>
                            - Extra letters processed at a fee and take 2 days.
                        </li>
                        <li>
                            - Collect all Results Slips, Certificates, and Projects within 6 months after exams.
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div>
             <div class="w-1/4">
                <Link :href="route('page.five')" class="flex items-center gap-2 px-6 py-3 text-white text-xl font-josefin tracking-wider font-bold 
