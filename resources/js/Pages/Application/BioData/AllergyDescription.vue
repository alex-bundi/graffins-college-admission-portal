...
const success = ref({});
const form = useForm({
    allergyDescription: props.applicant ? props.applicant.allergy_description : null,
});

const hasChanged = computed(() => {
    return (
        form.allergyDescription !== (props.applicant.allergy_description ?? null)
    );
});
function submit(){
    ...
    if (hasChanged.value == true) {
        ...
        router.visit('/application/emergency-contact');
    }
...
<template>
    <Head title="Allergies Description" />
    <ApplicationLayout>
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                ...
                <p class="font-josefin font-bold text-base sm:text-xl tracking-wider">
                    You Selected Yes for Alergies,please give us a brief explanation below:                 </p>
            </div>
