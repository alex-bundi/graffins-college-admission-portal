...
const hasChanged = computed(() => {
    return (
        form.allergy !== (props.applicant.allergies ?? null)
    );
});
...
function submit(){
     ...
     if (hasChanged.value == true) {
        router.post('/application/post-allergies', form, {
            onError : (allErrors) => {
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                ...
                <p class="font-josefin font-bold text-base sm:text-xl tracking-wider">
                    Let us know about any medical allergies we should be aware of for your safety.
                </p>
            </div>
