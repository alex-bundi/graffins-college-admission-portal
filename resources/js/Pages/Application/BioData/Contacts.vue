...
const success = ref({});
const form = useForm({
    phoneNo: props.applicant ? props.applicant.phone_no : null,
});

const hasChanged = computed(() => {
    return (
        form.phoneNo !== (props.applicant?.phone_no ?? null)
    );
});
...
function submit(){
   ...
   if (hasChanged.value == true) {
        router.post('/application/post-contacts', form, {
            onError : (allErrors) => {
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                ...
                <p class="font-josefin font-bold text-base sm:text-xl tracking-wider">
                    What is your phone number? We'll use it to reach you if needed.
                </p>
            </div>
