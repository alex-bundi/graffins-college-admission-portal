...
function submit(){
    ...
    router.post('/application/post-tutor', form, {
        onError : (allErrors) => {
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                ...
                <p class="font-josefin font-bold text-base sm:text-xl tracking-wider">
                    Please select your tutor so we can guide you accordingly.
                </p>
            </div>
        </div>
                        ...
                        <ul class="grid w-full gap-6 md:grid-cols-3 mt-2">
                                <li v-for="tutor in tutors" :key="tutor.Tutor_Code">
                                    ...
                                    <label :for="tutor.Tutor_Code" class="inline-flex items-center justify-between w-full p-5 text-gray-500 
                                        ...
                                        <div class="block">
                                            <div class="w-full text-lg font-semibold">{{ tutor.Tutor_Names }}</div>
                                        </div>
                                       
                                    </label>
                                    <div class="text-red-500 tracking-wider font-josefin font-bold m-2 text-sm" v-if="form.errors.tutor">{{ form.errors.tutor }}</div>
