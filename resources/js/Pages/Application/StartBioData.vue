...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-row space-x-6 items-center">
            ...
            <div>
                <h1 class="font-monteserat text-xl tracking-wider md:text-4xl">
                  We’re going to ask you for some personal information now…
                </h1>
       ...
       <div>
             <div class="w-1/4">
                <Link :href="route('full.name')" class="flex items-center gap-2 px-6 py-3 text-white text-xl font-josefin tracking-wider font-bold 
